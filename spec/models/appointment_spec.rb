...
RSpec.describe Appointment, type: :model do
  SUNDAY_DATE = '2020/10/4'.freeze
  SUNDAY_TIME = '10:00 ~ 10:30'.freeze
  ...
  it '面談開始時間は30分刻みではない時間に予約すると無効であること' do
    appointment = Appointment.new(appointment_date: NOT_EVERY_THIRTY_MINUTES_DATE,
                                  appointment_time: NOT_EVERY_THIRTY_MINUTES_DATE_TIME)
    appointment.valid?
